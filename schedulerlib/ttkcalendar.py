...
def get_calendar(locale=None):
    if locale is None:
        return calendar.TextCalendar(calendar.MONDAY)
    else:
        return calendar.LocaleTextCalendar(calendar.MONDAY, locale)
...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, **kw):
        ...
        # --- init calendar
        # --- *-- header: month - year
        self._header = ttk.Frame(self, style=self._style_prefixe + '.main.TFrame')

        f_month = ttk.Frame(self._header, style=self._style_prefixe + '.main.TFrame')
        ...
        f_year = ttk.Frame(self._header, style=self._style_prefixe + '.main.TFrame')
