...
IM_STOP = os.path.join(PATH_IMAGES, 'stop.png')
IM_POMODORO = os.path.join(PATH_IMAGES, "pomodoro.png")
IM_GRAPH = os.path.join(PATH_IMAGES, "graph.png")
IM_COLOR = os.path.join(PATH_IMAGES, "color.png")
IM_SOUND = os.path.join(PATH_IMAGES, "sound.png")
IM_MUTE = os.path.join(PATH_IMAGES, "mute.png")
IM_SOUND_DIS = os.path.join(PATH_IMAGES, "sound_dis.png")
IM_MUTE_DIS = os.path.join(PATH_IMAGES, "mute_dis.png")
IM_CLOSED = os.path.join(PATH_IMAGES, 'closed.png')
IM_OPENED = os.path.join(PATH_IMAGES, 'opened.png')
IM_CLOSED_SEL = os.path.join(PATH_IMAGES, 'closed_sel.png')
IM_OPENED_SEL = os.path.join(PATH_IMAGES, 'opened_sel.png')
IM_LAYOUT = os.path.join(PATH_IMAGES, 'layout.png')
IM_GRID = os.path.join(PATH_IMAGES, 'grid.png')
IM_WEEK = os.path.join(PATH_IMAGES, 'week.png')
IM_MONTH = os.path.join(PATH_IMAGES, 'month.png')
